 ...
 *
 * This script parses *Demo.tsx files and extracts clean, production-ready
 * examples suitable for the component registry and AI consumption.
 *
 * Run: pnpm codegen:demos
 * Output: dist/demo-metadata.json (consumed by @aolda/ui registry generator)
 *
...
function main() {
  console.log("Extracting demo examples from ui-docs...\n");
