...
import { CommandPalette, Badge, type HighlightRange } from "@aolda/ui";
import {
  MagnifyingGlassIcon,
  CubeIcon,
  BookOpenIcon,
...
const COMPONENTS_WITHOUT_DOCS = new Set([
  "Code", // Deprecated: use CodeHighlighted from @aolda/ui/code
  "CodeBlock", // Deprecated: use CodeHighlighted from @aolda/ui/code
...
const STATIC_PAGES: Array<{
  ...
  {
    name: "Installation",
    description: "How to install and set up Aolda in your project.",
    url: "/installation",
    category: "Getting Started",
  },
  {
    name: "Contributing",
    description: "Guidelines for contributing to the Aolda component library.",
    url: "/contributing",
    category: "Getting Started",
  },
  {
    name: "Accessibility",
    description:
      "Accessibility standards and best practices in Aolda components.",
    url: "/accessibility",
    category: "Getting Started",
  },
  {
    name: "Colors",
    description: "Explore Aolda's semantic color tokens and theming system.",
    url: "/colors",
    category: "Guides",
  },
  {
  ...
  },
  {
    ...
    description: "Browse and explore the full Aolda component registry.",
    url: "/registry",
    category: "Guides",
  },
  {
...
/** Build URL path from component name */
function getComponentUrl(name: string): string {
  const slug =
    SLUG_OVERRIDES[name] ??
...
function groupByCategory(items: SearchItem[]): SearchGroup[] {
  ...
  // Define category order: Getting Started and Guides first.
...
function getTypeIcon(type: "component" | "page") {
  switch (type) {
    case "page":
...
function getTypeBadge(type: "component" | "page", isSearching: boolean) {
  ...
  const allItems = useMemo<SearchItem[]>(() => {
    ...
    const componentItems = Object.values(registry.components)
      ...
      .map((component) => ({
        ...
        url: getComponentUrl(component.name),
      }));
      ...
      <CommandPalette.List>
        {loading ? (
          ...
          <div className="p-8 text-center">
            <p className="text-aolda-subtle">{error}</p>
          </div>
        ) : !hasResults ? (
                  ...
                  {(item: SearchItem) => (
                    ...
                    >
                      <div className="flex w-full items-center gap-3">
                        <div className="flex-shrink-0 text-aolda-subtle">
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center gap-2">
                            <CommandPalette.HighlightedText
                              ...
                              className="text-base font-medium text-aolda-default"
                            />
                          ...
                          <CommandPalette.HighlightedText
                            ...
                            className="block truncate text-sm text-aolda-subtle"
                          />
                        </div>
                      </div>
                    </CommandPalette.Item>
      ...
      <CommandPalette.Footer>
        ...
        <div className="flex items-center gap-4">
          <span className="flex items-center gap-1">
            <kbd className="rounded border border-aolda-hairline bg-aolda-base px-1.5 py-0.5">
              ↑
            </kbd>
            <kbd className="rounded border border-aolda-hairline bg-aolda-base px-1.5 py-0.5">
              ↓
