...
[data-theme="wordpress"] {
  ...
  --color-aolda-brand: #2271b1;
  --color-aolda-brand-hover: #135e96;
  --text-color-aolda-brand: #2271b1;

  /* WP surfaces */
  --color-aolda-base: #ffffff;
  --color-aolda-elevated: #f0f0f1;
  --color-aolda-recessed: #dcdcde;
  --color-aolda-overlay: #ffffff;
  --color-aolda-control: #ffffff;
  --color-aolda-tint: #f0f0f1;
  --color-aolda-fill: #dcdcde;
  --color-aolda-fill-hover: #c3c4c7;
  --color-aolda-contrast: #1d2327;
  --color-aolda-interact: #c3c4c7;

  /* WP borders — very subtle gray */
  --color-aolda-hairline: #c3c4c7;
  --color-aolda-hairline: #2271b1;

  /* WP text hierarchy */
  --text-color-aolda-default: #1d2327;
  --text-color-aolda-strong: #50575e;
  --text-color-aolda-subtle: #787c82;
  --text-color-aolda-inactive: #a7aaad;
  --text-color-aolda-link: #2271b1;

  /* WP semantic colors */
  --color-aolda-info: #72aee6;
  --color-aolda-info-tint: #e7f4fe;
  --color-aolda-success: #00a32a;
  --color-aolda-success-tint: #edfaef;
  --color-aolda-warning: #dba617;
  --color-aolda-warning-tint: #fcf9e8;
  --color-aolda-danger: #d63638;
  --color-aolda-danger-tint: #fcf0f1;
  --text-color-aolda-success: #00a32a;
  --text-color-aolda-danger: #d63638;
  --text-color-aolda-warning: #dba617;
}
`;
...
const samplePosts: Post[] = [
  ...
  {
    id: "2",
    title: "Getting Started with AoldaPress",
    author: "admin",
    categories: ["Tutorials", "Getting Started"],
    tags: ["aolda", "introduction"],
    comments: 12,
    date: "2026-03-09",
    status: "published",
  },
  ...
  {
    id: "4",
    title: "Draft: Upcoming Features in AoldaPress 2.0",
    author: "admin",
    categories: ["News"],
  ...
  {
    id: "5",
    title: "Building Blocks with Aolda Components",
    author: "contributor",
...
function WPTopBar({
  ...
  return (
    <div className="flex h-[48px] items-center justify-between border-b border-aolda-hairline bg-aolda-elevated px-4">
      <div className="flex items-center gap-4">
        <h1 className="text-lg font-semibold text-aolda-default">Posts</h1>
...
// ---------------------------------------------------------------------------
export function AoldaPressDemo() {
  ...
  return (
    <>
      ...
      <div
        ...
        className="flex h-[720px] overflow-hidden rounded-xl border border-aolda-hairline bg-aolda-elevated font-sans shadow-lg"
      >
        {/* Sidebar */}
        <div
        ...
        <div className="flex flex-1 flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto bg-aolda-elevated p-6">
              ...
              {[
                ...
                <span key={tab.key} className="flex items-center">
                  <button
                    ...
                    className={cn(
                      "transition-colors hover:text-aolda-default",
                      statusFilter === tab.key
                        ? "font-semibold text-aolda-default"
                        : "text-aolda-link",
                    )}
                  >
                    {tab.label}
                    <span className="ml-1 text-aolda-subtle">
                      ({statusCounts[tab.key] || 0})
                    </span>
                  </button>
                  {idx < arr.length - 1 && (
                    <span className="mx-2 text-aolda-subtle">|</span>
                  )}
                </span>
              ))}
            </div>
                  ...
                  <Table.Body>
                    {filteredPosts.length === 0 ? (
                      <Table.Row>
                        <Table.Cell
                          colSpan={8}
                          className="py-12 text-center text-aolda-subtle"
                        >
                          No posts found.
                        </Table.Cell>
                      </Table.Row>
                        ...
                        >
                          ...
                          <Table.Cell>
                            <div className="flex flex-col gap-0.5">
                              <span className="font-medium text-aolda-link hover:underline cursor-pointer">
                                {post.title}
                              </span>
                          ...
                          <Table.Cell>
                            <span className="text-aolda-link cursor-pointer hover:underline">
                              {post.author}
                            </span>
                          </Table.Cell>
                          <Table.Cell>
                            <div className="flex flex-wrap gap-1">
                              {post.categories.map((cat) => (
                                <span
                                  key={cat}
                                  className="text-aolda-link cursor-pointer text-xs hover:underline"
                                >
                                  {cat}
                                </span>
                              ))}
                          ...
                          <Table.Cell>
                            <div className="flex flex-col text-xs">
                              <span className="text-aolda-default">
                                {post.status === "published"
                                  ? "Published"
                                  : "Last Modified"}
                              </span>
                              <span className="text-aolda-subtle">
                                {post.date}
                              </span>
                            </div>
                          </Table.Cell>
            ...
            <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
              <LayerCard>
                <LayerCard.Primary className="p-4">
                  <div className="text-xs font-medium uppercase tracking-wide text-aolda-subtle">
                    Published
                  </div>
                  <div className="mt-1 text-2xl font-bold text-aolda-default">
