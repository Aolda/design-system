...
export function CodeHighlightedFullFeaturedDemo() {
  return (
    <DemoProvider>
      <CodeHighlighted
        code={`import { ShikiProvider, CodeHighlighted } from "@aolda/ui/code";
...
export function CodeHighlightedCustomHighlightDemo() {
  ...
  return (
    <DemoProvider>
      <div className="space-y-4">
        <style>{`
          #${styleId} .aolda-shiki {
            --aolda-code-highlight-bg: ${lightBg};
          }
          [data-mode="dark"] #${styleId} .aolda-shiki {
            --aolda-code-highlight-bg: ${darkBg};
          }
        `}</style>
        <div id={styleId}>
          <CodeHighlighted
  ...
  return name.toUpperCase();
        ...
        <div className="flex flex-wrap gap-6 rounded-md border border-aolda-hairline bg-aolda-elevated p-4">
          <label className="flex flex-col gap-2">
            <span className="text-sm text-aolda-subtle">Hue: {hue}°</span>
            <input
              type="range"
              min="0"
              max="360"
          ...
          <div className="flex flex-col gap-2">
            <span className="text-sm text-aolda-subtle">CSS Variable</span>
            <code className="rounded bg-aolda-control px-2 py-1 font-mono text-xs">
              --aolda-code-highlight-bg: {lightBg}
            </code>
          </div>
        </div>
