...
import { Select, Text, Badge } from "@aolda/ui";
  ...
  return (
    <div className="grid gap-4">
      <div className="flex items-center gap-3">
        <span className="w-10 text-sm text-aolda-subtle">xs</span>
        <Select
      ...
      <div className="flex items-center gap-3">
        <span className="w-10 text-sm text-aolda-subtle">sm</span>
        <Select
      ...
      <div className="flex items-center gap-3">
        <span className="w-10 text-sm text-aolda-subtle">base</span>
        <Select
      ...
      <div className="flex items-center gap-3">
        <span className="w-10 text-sm text-aolda-subtle">lg</span>
        <Select
