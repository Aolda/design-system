import { Grid, GridItem, Surface, Text } from "@aolda/ui";
...
export function GridVariantsDemo() {
  return (
    <div className="flex flex-col gap-8">
      <div>
        <p className="mb-2 text-aolda-subtle">variant="2up"</p>
      ...
      <div>
        <p className="mb-2 text-aolda-subtle">variant="3up"</p>
      ...
      <div>
        <p className="mb-2 text-aolda-subtle">variant="4up"</p>
...
export function GridAsymmetricDemo() {
  return (
    <div className="flex flex-col gap-8">
      <div>
        <p className="mb-2 text-aolda-subtle">variant="2-1" (66% / 33%)</p>
      ...
      <div>
        <p className="mb-2 text-aolda-subtle">variant="1-2" (33% / 66%)</p>
...
export function GridGapDemo() {
  return (
    <div className="flex flex-col gap-8">
      <div>
        <p className="mb-2 text-aolda-subtle">gap="none"</p>
      ...
      <div>
        <p className="mb-2 text-aolda-subtle">gap="sm"</p>
      ...
      <div>
        <p className="mb-2 text-aolda-subtle">
      ...
      <div>
        <p className="mb-2 text-aolda-subtle">gap="lg"</p>
