...
import { Dialog, Button, Select, Combobox, DropdownMenu } from "@aolda/ui";
  ...
  return (
    <Dialog.Root>
      ...
      <Dialog className="p-8">
        ...
        <Dialog.Description className="text-aolda-subtle">
    ...
    <Dialog.Root disablePointerDismissal>
      ...
      <Dialog className="p-8">
        <div className="mb-4 flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-full bg-aolda-danger/20">
            <Warning size={20} className="text-aolda-danger" />
          </div>
  ...
  return (
    <Dialog.Root role="alertdialog">
      ...
      <Dialog className="p-8">
        <div className="mb-4 flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-full bg-aolda-danger/20">
            <Warning size={20} className="text-aolda-danger" weight="fill" />
          </div>
          <Dialog.Title className="text-xl font-semibold">
            Delete Account?
          </Dialog.Title>
  ...
  return (
    <Dialog.Root>
      ...
      <Dialog className="p-8">
        ...
        <Dialog.Description className="mb-4 text-aolda-subtle">
