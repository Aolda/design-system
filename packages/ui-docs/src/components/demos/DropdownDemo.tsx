...
import { DropdownMenu, Button } from "@aolda/ui";
import {
  PlusIcon,
  UserIcon,
  CreditCardIcon,
...
export function DropdownAvatarTriggerDemo() {
  return (
    <DropdownMenu>
      ...
      >
        <span className="flex h-8 w-8 items-center justify-center rounded-full bg-aolda-brand text-sm font-medium text-white">
          MR
        </span>
      </DropdownMenu.Trigger>
      <DropdownMenu.Content>
