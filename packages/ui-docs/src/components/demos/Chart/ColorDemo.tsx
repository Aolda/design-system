import { ChartPalette, Chart, LayerCard, Table } from "@aolda/ui";
...
export function ChartColorSystemsDemo() {
  return (
    <LayerCard>
      ...
      <Table className="!m-0 !p-0 [&_tbody]:text-sm [&_tbody]:font-medium [&_tbody]:text-aolda-default">
        <colgroup>
          <col className="w-[14%]" />
          <col className="w-[38%]" />
          <col className="w-[16%]" />
      ...
      <LayerCard.Primary className="!p-0 !m-0">
        <Table
          layout="fixed"
          className="!p-0 !m-0 w-full [&_td]:align-top [&_td]:text-aolda-default"
        >
          <colgroup>
            <col className="w-[14%]" />
            <col className="w-[38%]" />
