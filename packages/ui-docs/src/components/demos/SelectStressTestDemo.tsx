...
export function SelectStrictNullChecksDemo() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded bg-aolda-tint p-3 text-sm">
...
const priorities: Priority[] = [
  { level: 1, name: "Critical", color: "text-aolda-danger" },
  { level: 2, name: "High", color: "text-aolda-warning" },
  { level: 3, name: "Medium", color: "text-aolda-default" },
  { level: 4, name: "Low", color: "text-aolda-subtle" },
];
