...
import { CommandPalette, Button } from "@aolda/ui";
import {
  GearIcon,
  FileIcon,
  FolderIcon,
    ...
    <div className="flex flex-col items-start gap-4">
      ...
      {selectedItem && (
        <p className="text-sm text-aolda-subtle">
          Last selected:{" "}
          <span className="text-aolda-default">{selectedItem}</span>
        </p>
      )}
      ...
      >
                  ...
                  {(item: CommandItem) => (
                    ...
                    >
                      <span className="flex items-center gap-3">
                        {item.icon && (
                          <span className="text-aolda-subtle">{item.icon}</span>
                        )}
        ...
        <CommandPalette.Footer>
          <span className="flex items-center gap-2">
            <kbd className="rounded border border-aolda-hairline bg-aolda-base px-1.5 py-0.5 text-[10px]">
              ↑↓
            </kbd>
            <span>Navigate</span>
          </span>
