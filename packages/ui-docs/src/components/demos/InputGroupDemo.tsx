...
import { InputGroup, Loader } from "@aolda/ui";
import {
  MagnifyingGlassIcon,
  CheckCircleIcon,
  XCircleIcon,
...
export function InputGroupDemo() {
  ...
  const [value, setValue] = useState("aolda");
...
export function InputGroupLoadingDemo() {
  return (
    <InputGroup className="w-full max-w-3xs">
      <InputGroup.Input defaultValue="aolda" aria-label="aolda" />
      <InputGroup.Addon align="end">
        <Loader />
      </InputGroup.Addon>
    </InputGroup>
  ...
  return (
    <div className="flex w-full max-w-2xs flex-col gap-4">
      <InputGroup label="Subdomain">
        ...
        <InputGroup.Suffix>.workers.dev</InputGroup.Suffix>
        <InputGroup.Addon align="end">
          <CheckCircleIcon weight="duotone" className="text-aolda-success" />
        </InputGroup.Addon>
      </InputGroup>
      ...
      >
        ...
        <InputGroup.Suffix>.workers.dev</InputGroup.Suffix>
        <InputGroup.Addon align="end">
          <XCircleIcon weight="duotone" className="text-aolda-danger" />
        </InputGroup.Addon>
      </InputGroup>
    </div>
  );
