import { SkeletonLine } from "@aolda/ui";
...
function DemoWrapper({
  ...
  return (
    <div className="relative">
      <div className="absolute top-0 bottom-0 right-full mr-2 border-r-2 border-aolda-fill flex items-center pr-2 text-sm">
        {label}
      </div>
      {children}
    </div>
...
export function SkeletonLineCardDemo() {
  return (
    <div className="w-64 rounded-lg p-4 ring ring-aolda-hairline">
