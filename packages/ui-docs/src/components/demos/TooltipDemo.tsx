import { Tooltip, TooltipProvider, Button } from "@aolda/ui";
  ...
  return (
    <TooltipProvider>
      <Tooltip
        ...
        className="inline-flex items-center gap-1.5 rounded-full bg-aolda-brand px-3 py-1.5 text-sm font-medium text-white shadow-md transition-transform hover:scale-105 active:scale-95"
      >
