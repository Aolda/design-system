...
import { TableOfContents as TOC } from "@aolda/ui";
    ...
    return (
      <nav aria-label="Table of contents" ref={navRef} className="relative">
        <select
          ...
          className="w-full appearance-none rounded-lg border border-aolda-hairline bg-aolda-base px-4 py-2.5 pr-10 text-sm text-aolda-default"
        >
        ...
        <CaretDownIcon
          size={16}
          weight="bold"
          className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-aolda-subtle"
        />
      </nav>
    );
  }
