...
import { Button, DropdownMenu } from "@aolda/ui";
import {
  CopySimpleIcon,
  LinkSimpleIcon,
  FileMdIcon,
...
export function CopyPageButton({ align = "end" }: CopyPageButtonProps) {
  ...
  const getAIPromptUrl = (baseUrl: string) => {
    ...
    const prompt = encodeURIComponent(
      `Read through this Aolda documentation: ${markdownUrl}. I'll need your help to understand it, so be prepared to explain concepts, share examples, and assist with debugging.`,
    );
