...
export function StickyDocHeader({
  ...
  return (
    <>
      {/* Sticky title that appears when sidebar is collapsed - positioned after the brand label */}
      {!sidebarOpen && (
        <div
          className={cn(
          ...
          <span className="pointer-events-auto flex items-center gap-2 text-base">
            ...
            {githubSourceUrl && (
              <a
                ...
                className="text-aolda-subtle transition-colors hover:text-aolda-strong"
      ...
      <header
        ref={headerRef}
        className="sticky flex h-12 top-12 md:top-0 z-10 border-b border-aolda-hairline bg-aolda-elevated"
      >
        <div className="flex min-w-0 flex-1 items-center justify-between px-4 md:border-r md:border-aolda-hairline">
          <div
            className={cn(
          ...
          >
            <span className="text-lg font-semibold tracking-tight text-aolda-default">
              {title}
            </span>
            {githubSourceUrl && (
              <a
          ...
          <a
            href="https://github.com/Aolda/design-system"
            target="_blank"
            rel="noopener noreferrer"
            className="font-mono text-sm text-aolda-subtle transition-colors hover:text-aolda-default"
          >
            @aolda/ui
          </a>
        </div>
