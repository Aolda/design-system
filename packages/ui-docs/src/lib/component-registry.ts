 ...
 * Reads from the auto-generated component-registry.json in the aolda package.
 */

// Import the registry JSON from the aolda package export
import registry from "@aolda/ui/registry/component-registry.json";

// Import shared types from @aolda/ui
import type {
  ComponentRegistry,
  ComponentSchema,
  PropSchema,
