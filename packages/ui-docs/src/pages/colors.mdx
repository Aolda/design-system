...
title: "Colors"
description: "Aolda uses semantic color tokens that automatically adapt to light and dark mode. Use these classes in your Tailwind CSS instead of raw color values."
---
...
```tsx
<div className="bg-aolda-base text-aolda-default border-aolda-hairline">
  <button className="bg-aolda-brand text-white">Primary</button>
  <button className="bg-aolda-control text-aolda-default">Secondary</button>
</div>
```
...
<div className="bg-aolda-base text-aolda-default" />
```
...
pnpm --filter @aolda/ui codegen:themes --list

# Generate theme CSS files

pnpm --filter @aolda/ui codegen:themes

# Preview changes without writing files

pnpm --filter @aolda/ui codegen:themes --dry-run
```

Theme config: `packages/ui/scripts/theme-generator/config.ts`

### Creating a New Theme

Add theme overrides in the config file. Only override tokens that need to change — all other tokens inherit from the base aolda theme.
...
export const AVAILABLE_THEMES = ["aolda", "fedramp", "myTheme"] as const;
```
...
Semantic tokens are named by **role**, not by hue. A token like `bg-aolda-danger` communicates intent — it doesn't imply a specific shade of red, and its exact value can change per theme or color mode without touching your component code.
...
<div style="overflow-x: auto;">
  <table>
    ...
    <tbody>
      <tr>
        <td><code>bg-aolda-brand</code></td>
        <td>Primary brand background</td>
      </tr>
      <tr>
        <td><code>bg-aolda-brand-hover</code></td>
...
<div style="overflow-x: auto;">
  <table>
    ...
    <tbody>
      <tr>
        <td><code>bg-aolda-info</code></td>
        <td>Info indicator (icon, dot, bar)</td>
      </tr>
      <tr>
        <td><code>bg-aolda-success</code></td>
        <td>Success indicator</td>
      </tr>
      <tr>
        <td><code>bg-aolda-warning</code></td>
        <td>Warning indicator</td>
      </tr>
      <tr>
        <td><code>bg-aolda-danger</code></td>
...
<div className="bg-aolda-danger-tint text-aolda-danger">
  <AlertIcon className="text-aolda-danger" />
...
<div style="overflow-x: auto;">
  <table>
    ...
    <tbody>
      <tr>
        <td><code>text-aolda-default</code></td>
        <td>Primary body text</td>
      </tr>
      <tr>
        <td><code>text-aolda-strong</code></td>
        <td>Secondary text with slightly less contrast than default</td>
      </tr>
      <tr>
        <td><code>text-aolda-subtle</code></td>
        <td>Muted text for descriptions, captions, or secondary labels</td>
      </tr>
      <tr>
        <td><code>text-aolda-inactive</code></td>
        <td>Disabled or inactive text</td>
      </tr>
      <tr>
        <td><code>text-aolda-placeholder</code></td>
        <td>Placeholder text in inputs</td>
      </tr>
      <tr>
        <td><code>text-aolda-inverse</code></td>
        <td>Text intended for use on high-contrast or inverted backgrounds</td>
      </tr>
      <tr>
        <td><code>text-aolda-link</code></td>
        <td>Link text</td>
      </tr>
      <tr>
        <td><code>text-aolda-info</code></td>
        <td>Info-colored text</td>
      </tr>
      <tr>
        <td><code>text-aolda-success</code></td>
        <td>Success-colored text</td>
      </tr>
      <tr>
        <td><code>text-aolda-warning</code></td>
        <td>Warning-colored text</td>
      </tr>
      <tr>
        <td><code>text-aolda-danger</code></td>
...
<div style="overflow-x: auto;">
  <table>
    ...
    <tbody>
      ...
      <tr>
        <td><code>aolda-hairline</code></td>
