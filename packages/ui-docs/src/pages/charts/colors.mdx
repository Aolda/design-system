...
title: "Chart Colors"
description: "Semantic and categorical color tokens for Aolda dashboard charts."
...
import { Banner } from "@aolda/ui";

Chart colors in Aolda are split into three systems — **semantic** tokens for data with inherent
...
<div class="text-aolda-info bg-aolda-info-tint/50 rounded-lg py-1 px-4 ring ring-aolda-info mb-12">
...
<div class="text-aolda-info bg-aolda-info-tint/50 rounded-lg py-1 px-4 ring ring-aolda-info mb-6">
