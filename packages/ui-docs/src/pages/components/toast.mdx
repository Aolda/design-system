...
```tsx
import { Toasty, useAoldaToastManager } from "@aolda/ui";
```

### Granular

```tsx
import { Toasty, useAoldaToastManager } from "@aolda/ui/components/toast";
```
...
## Usage
  ...
  <p>
    The toast system consists of two parts: the `Toasty` provider component and the `useAoldaToastManager()` hook for triggering toasts.
  </p>

```tsx
import { Toasty, useAoldaToastManager, Button } from "@aolda/ui";
...
<div class="overflow-x-auto">
  <table class="w-full text-left text-sm">
    ...
    <tbody class="text-aolda-subtle">
      <tr class="border-b border-aolda-hairline">
        <td class="py-3 pr-4 font-mono text-aolda-default">title</td>
        <td class="py-3 pr-4 font-mono">string</td>
        <td class="py-3 pr-4">—</td>
        <td class="py-3">The toast title displayed prominently.</td>
      </tr>
      <tr class="border-b border-aolda-hairline">
        <td class="py-3 pr-4 font-mono text-aolda-default">description</td>
        <td class="py-3 pr-4 font-mono">string</td>
        <td class="py-3 pr-4">—</td>
      ...
      <tr class="border-b border-aolda-hairline">
        <td class="py-3 pr-4 font-mono text-aolda-default">content</td>
      ...
      <tr class="border-b border-aolda-hairline">
        <td class="py-3 pr-4 font-mono text-aolda-default">actions</td>
        <td class="py-3 pr-4 font-mono">ButtonProps[]</td>
        <td class="py-3 pr-4">—</td>
        <td class="py-3">Array of button props to render as action buttons.</td>
      </tr>
      <tr class="border-b border-aolda-hairline">
        <td class="py-3 pr-4 font-mono text-aolda-default">timeout</td>
