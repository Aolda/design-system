...
```tsx
import { Popover } from "@aolda/ui";
```

### Granular

```tsx
import { Popover } from "@aolda/ui/components/popover";
```
    ...
    <table class="w-full text-sm">
      ...
      <tbody class="divide-y divide-aolda-hairline">
        <tr>
          ...
          <td class="px-4 py-3 text-aolda-subtle">
        ...
        <tr>
          ...
          <td class="px-4 py-3 text-aolda-subtle">Plain text only</td>
          <td class="px-4 py-3 text-aolda-subtle">
        ...
        <tr>
          ...
          <td class="px-4 py-3 text-aolda-subtle">Hover or focus</td>
          <td class="px-4 py-3 text-aolda-subtle">Click (default) or hover</td>
        </tr>
        <tr>
          <td class="px-4 py-3 font-medium">ARIA Role</td>
          <td class="px-4 py-3">
            <code class="rounded bg-aolda-elevated px-1.5 py-0.5 font-mono text-xs">
              role="tooltip"
            </code>
          </td>
          <td class="px-4 py-3">
        ...
        <tr>
          ...
          <td class="px-4 py-3 text-aolda-subtle">Not focusable</td>
          <td class="px-4 py-3 text-aolda-subtle">
