...
### Barrel
  ...
  <CodeBlock code={`import { Dialog } from "@aolda/ui";`} lang="tsx" />

### Granular

  <CodeBlock
    code={`import { Dialog } from "@aolda/ui/components/dialog";`}
    lang="tsx"
  />
</ComponentSection>
...
```tsx
import { Dialog, Button } from "@aolda/ui";
...
## Dialog vs Alert Dialog
  ...
  <div class="overflow-hidden rounded-lg border border-aolda-hairline">
    <table class="w-full text-sm">
      <thead class="bg-aolda-elevated">
        <tr>
      ...
      <tbody class="divide-y divide-aolda-hairline">
        <tr>
          <td class="px-4 py-3">
            `role="dialog"`
            <span class="ml-2 text-aolda-subtle">(default)</span>
          </td>
          <td class="px-4 py-3">
...
<div class="mb-4 rounded-lg border border-aolda-info/30 bg-aolda-info/10 p-4 text-sm text-aolda-info">
  <p class="font-medium mb-2 text-sm">
    When to use{" "}
    <code class="bg-aolda-info/20 px-1 rounded">role="alertdialog"</code>:
  </p>
...
<div class="mb-4 overflow-hidden rounded-lg border border-aolda-hairline">
  <table class="w-full text-sm">
    <thead class="bg-aolda-elevated">
      <tr>
    ...
    <tbody class="divide-y divide-aolda-hairline">
      <tr>
        ...
        <td class="px-4 py-2 text-aolda-subtle">
