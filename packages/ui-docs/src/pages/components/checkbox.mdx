...
<CodeBlock code={`import { Checkbox } from "@aolda/ui";`} lang="tsx" />

### Granular

  <CodeBlock
    code={`import { Checkbox } from "@aolda/ui/components/checkbox";`}
    lang="tsx"
  />
</ComponentSection>
...
## Accessibility
  ...
  <div class="space-y-4 text-sm">
    ...
    <div>
      ...
      <p>
        <kbd class="rounded bg-aolda-control px-1.5 py-0.5">Space</kbd> toggles
        the checkbox.
