 ...
 * - Styling metadata for docs and design tooling
 */
...
> = {
  Chart: {
    echarts: {
      ...
      required: true,
      description:
        "ECharts core instance imported by the consumer so the consumer controls bundled chart modules.",
    },
    options: {
    ...
    optionUpdateBehavior: {
      ...
      default: "{ notMerge: false, lazyUpdate: true }",
    },
    isDarkMode: {
      type: "boolean",
      description:
        "Initializes ECharts with its built-in dark theme when true.",
    },
    height: {
      type: "number",
...
/**
 * Component-specific styling metadata for docs and design tooling.
...
export const COMPONENT_STYLING_METADATA: Record<string, ComponentStyling> = {
  Checkbox: {
    ...
    baseTokens: ["bg-aolda-base", "ring-aolda-line"],
    states: {
      checked: ["bg-aolda-contrast", "text-aolda-inverse"],
      indeterminate: ["bg-aolda-contrast", "text-aolda-inverse"],
      error: ["ring-aolda-danger"],
      hover: ["ring-aolda-hairline"],
      focus: ["ring-aolda-hairline"],
  ...
  ClipboardText: {
    ...
    states: {
      input: ["bg-aolda-control", "text-aolda-default", "ring-aolda-line"],
      text: ["bg-aolda-base", "font-mono"],
      button: ["border-aolda-fill"],
    },
    inputStyles: {
      base: "bg-aolda-control text-aolda-default ring ring-aolda-line",
      sizes: {
  ...
  Input: {
    ...
    states: {
      base: ["bg-aolda-control", "text-aolda-default", "ring-aolda-line"],
      focus: ["ring-aolda-hairline"],
      error: ["ring-aolda-danger"],
      disabled: ["opacity-50", "text-aolda-subtle"],
    },
  },
  Tabs: {
    container: {
  ...
  Dialog: {
    ...
    states: {
      base: ["bg-aolda-base", "text-aolda-default", "shadow-m"],
      backdrop: ["bg-aolda-overlay", "opacity-80"],
    },
  },
  // Note: Toasty styling is now extracted from AOLDA_TOAST_STYLING in toast.tsx
  DateRangePicker: {
    sizeVariants: {
      sm: {
        height: 0,
