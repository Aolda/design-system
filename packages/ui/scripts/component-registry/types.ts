...
export interface ComponentConfig {
   ...
   * Extracted from AOLDA_*_BASE_STYLES constant if present.
   */
  baseStyles?: string;
  /**
   * Component-specific styling metadata.
   * Extracted from AOLDA_*_STYLING constant if present.
   */
...
export interface ComponentOverride {
  ...
  /** Override props type */
  propsType?: string;
  /** Override source file path relative to source dir */
  sourceFile?: string;
