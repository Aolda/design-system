...
try {
  const standaloneInput = join(srcDir, "aolda-standalone.css");
  const standaloneOutput = join(distDir, "aolda-standalone.css");
  ...
  console.log("✓ Compiled aolda-standalone.css");
} catch (error) {
