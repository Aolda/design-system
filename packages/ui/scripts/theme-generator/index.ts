...
function printHelp() {
  console.log(`
Aolda Theme Generator

Usage:
  tsx scripts/aolda-theme-generator/index.ts [options]
...
Output:
  ...
  - theme-aolda.css     Base theme with all tokens
...
async function main() {
  ...
  console.log("Aolda Theme Generator\n");
