/**
 * Type definitions for the Aolda component registry.
...
export interface PropSchema {
  ...
  /** Tailwind classes for each variant value, used by docs and tooling */
...
export interface ComponentSchema {
   ...
   * Useful for docs and tooling to parse layout, spacing, typography.
   */
  baseStyles?: string;
