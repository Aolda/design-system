 ...
 * ```tsx
 * // Next.js RSC
 * import { highlightCode, CodeBlock } from "@aolda/ui/code/server";
 *
...
/**
 * Pre-bundled languages - only these languages are included in the Aolda bundle.
 ...
 * to render syntax-highlighted code blocks with consistent Aolda styling.
 *
 * @example
 * ```tsx
 * import { highlightCode, CodeBlock } from "@aolda/ui/code/server";
...
export function CodeBlock({ html, className }: CodeBlockProps): ReactNode {
  const containerClass = className
    ? `group relative w-full min-w-0 rounded-md border border-aolda-fill bg-aolda-base ${className}`
    : "group relative w-full min-w-0 rounded-md border border-aolda-fill bg-aolda-base";

  return (
    <div className={containerClass}>
      <div className="overflow-x-auto">
        <div
          className="aolda-shiki [&>pre]:p-4 [&>pre]:font-mono [&>pre]:text-sm [&>pre]:leading-relaxed"
