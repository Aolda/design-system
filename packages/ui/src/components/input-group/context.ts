...
export const INPUT_GROUP_SIZE: Record<AoldaInputSize, InputGroupSizeTokens> = {
  xs: {
    inputOuter: "px-1.5",
...
export const INPUT_GROUP_HAS_CLASSES: Record<AoldaInputSize, string> = {
  xs: [
