...
export const AOLDA_INPUT_GROUP_VARIANTS = {
  size: {
    xs: {
      classes: "h-6 text-xs",
...
export const AOLDA_INPUT_GROUP_DEFAULT_VARIANTS = {
  size: "base",
} as const;
...
>(
  (
    ...
    const containerClassName = cn(
      ...
      // inputVariants provides base ring-aolda-line; must come before state overrides
      inputVariants({ size }),
      ...
      focusMode === "container"
        ? [
            "overflow-hidden",
            // Focus state must come AFTER inputVariants to override ring-aolda-line
      ...
      "has-[input[aria-invalid=true]]:ring-aolda-danger",
    ...
    // Data attributes drive CSS selectors in aolda-binding.css (focus outline)
          ...
          <InputGroupContext.Provider value={containerZoneContext}>
            <div
              ...
              className={cn(
                ...
                "ring-0 shadow-none",
                "border border-aolda-line",
                "focus-within:ring-1 focus-within:ring-aolda-focus",
