...
import { Tooltip, type AoldaTooltipSide } from "../tooltip/tooltip";
 ...
 */
const COMPACT_BUTTON_SIZE: Record<AoldaInputSize, AoldaInputSize> = {
  xs: "xs",
  sm: "xs",
  base: "sm",
  lg: "base",
      ...
      <ButtonExternal
        ...
        className={cn(
          ...
          isIndividual && [
            ...
            "relative h-full! rounded-none ring-0 border border-aolda-line",
            ...
            "focus:z-[2] focus:border-aolda-line focus:outline focus:-outline-offset-1",
            // Suppress the base Button's focus ring so only our outline shows
            "focus-visible:ring-2 focus-visible:ring-aolda-focus",
            // Match the group's disabled visual treatment
            "disabled:bg-aolda-overlay disabled:text-aolda-inactive!",
          ],
          className,
        )}
      >
