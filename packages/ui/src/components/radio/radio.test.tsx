...
describe("Radio", () => {
  ...
  it("exports AOLDA_RADIO_VARIANTS with appearance axis", () => {
    expect(AOLDA_RADIO_VARIANTS.appearance.default).toBeDefined();
    expect(AOLDA_RADIO_VARIANTS.appearance.card).toBeDefined();
    expect(AOLDA_RADIO_DEFAULT_VARIANTS.appearance).toBe("default");
  });
});
