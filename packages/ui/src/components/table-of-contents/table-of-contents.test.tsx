...
describe("TableOfContents", () => {
  ...
  it("should have active state variant classes", () => {
    expect(AOLDA_TABLE_OF_CONTENTS_VARIANTS.state.active.classes).toContain(
      "text-aolda-default",
    );
    expect(AOLDA_TABLE_OF_CONTENTS_VARIANTS.state.active.classes).toContain(
      "font-medium",
  ...
  it("should have default state variant classes", () => {
    expect(AOLDA_TABLE_OF_CONTENTS_VARIANTS.state.default.classes).toContain(
      "text-aolda-subtle",
    );
  });

  it("should default to inactive state", () => {
    expect(AOLDA_TABLE_OF_CONTENTS_DEFAULT_VARIANTS.state).toBe("default");
  });
