...
// ============================================================================
// Variants (required by Aolda convention)
// ============================================================================

/** Sidebar variant definitions mapping layout, collapse, and side options. */
export const AOLDA_SIDEBAR_VARIANTS = {
  variant: {
    sidebar: {
      classes: "",
...
export const AOLDA_SIDEBAR_DEFAULT_VARIANTS = {
  variant: "sidebar",
  collapsible: "icon",
  side: "left",
} as const;

export const AOLDA_SIDEBAR_STYLING = {
  width: {
    expanded: "16rem",
    icon: "3rem",
  },
...
function SidebarProvider({
  ...
  variant = AOLDA_SIDEBAR_DEFAULT_VARIANTS.variant,
  side = AOLDA_SIDEBAR_DEFAULT_VARIANTS.side,
  collapsible = AOLDA_SIDEBAR_DEFAULT_VARIANTS.collapsible,
  resizable = false,
    ...
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        className={cn(
          ...
          "has-data-[variant=inset]:bg-aolda-recessed",
    ...
    if (collapsible === "none") {
      return (
        <aside
          ...
          className={cn(
            "relative flex h-full shrink-0 grow-0 flex-col overflow-hidden bg-aolda-base text-aolda-default",
            variant === "sidebar" &&
              (side === "left"
                ? "border-r border-aolda-hairline"
                : "border-l border-aolda-hairline"),
            variant === "floating" &&
              "m-2 rounded-lg border border-aolda-hairline shadow-lg",
            className,
          )}
          {...props}
        >
      ...
      return (
        <DialogBase.Root open={openMobile} onOpenChange={setOpenMobile}>
          <DialogBase.Portal>
            ...
            <DialogBase.Popup
              className={cn(
                "fixed inset-y-0 z-50 flex w-[--sidebar-width] flex-col bg-aolda-base p-0",
            ...
            >
              <div
                ...
                data-mobile="true"
                className={cn(
                  "flex h-full w-full flex-col bg-aolda-base text-aolda-default",
                  className,
                )}
              >
                {children}
    ...
    return (
      <aside
        ...
        className={cn(
          ...
          "bg-aolda-base text-aolda-default",
...
>(({ className, ...props }, ref) => (
  <div
    ...
    data-sidebar="header"
    className={cn(
      "flex items-center gap-2 border-b border-aolda-hairline px-2 py-3",
      "overflow-hidden",
...
>(({ className, ...props }, ref) => (
  <div
    ...
    data-sidebar="footer"
    className={cn(
      "flex min-w-0 flex-col gap-2 border-t border-aolda-hairline px-2 py-2",
...
>(({ className, children, ...props }, ref) => {
  ...
  if (isCollapsible) {
    return (
      <CollapsibleBase.Trigger
        ...
        className={cn(
          "group/group-label flex w-full cursor-pointer items-center px-3 py-1 text-xs font-medium text-aolda-subtle",
      ...
      >
        ...
        <CaretRightIcon
          className={cn(
            "ml-auto size-3 shrink-0 text-aolda-subtle transition-transform duration-200",
  ...
  return (
    <div
      ...
      data-sidebar="group-label"
      className={cn(
        "truncate px-3 py-1 text-xs font-medium text-aolda-subtle",
        "group-data-[state=collapsed]/sidebar:hidden",
        className,
      )}
      {...props}
...
const SidebarMenuButton = forwardRef<HTMLButtonElement, SidebarMenuButtonProps>(
  (
    ...
    const buttonClasses = cn(
      ...
      // Icon color
      "[&>svg]:text-aolda-subtle",
      !active && "hover:bg-aolda-tint",
      // Active state
      active && "bg-aolda-tint",
      // When a child sub-button is active, don't show active styling on the parent trigger
      "has-[[data-active]]:bg-transparent has-[[data-active]]:hover:bg-aolda-tint",
      // Focus
      "focus-visible:ring-2 focus-visible:ring-aolda-brand",
...
>(({ className, ...props }, ref) => (
  <button
    ...
    className={cn(
      ...
      "text-aolda-strong hover:bg-aolda-overlay",
      "focus-visible:ring-2 focus-visible:ring-aolda-brand",
...
>(({ className, ...props }, ref) => (
  <span
    ...
    className={cn(
      "inline-flex shrink-0 items-center rounded-full border border-dashed border-aolda-hairline",
      "select-none px-1.5 py-0.5 text-[11px]/none font-medium text-aolda-strong",
...
>(({ className, ...props }, ref) => (
  <ul
    ...
    className={cn(
      "m-0 ml-3.5 flex min-w-0 list-none flex-col gap-0.5 border-l border-aolda-hairline p-0 pl-2.5",
      // Hidden when collapsed
      "group-data-[state=collapsed]/sidebar:hidden",
      className,
    )}
...
>(({ className, active = false, href, children, ...props }, ref) => {
  ...
  const buttonClasses = cn(
    ...
    "text-aolda-default transition-colors duration-150",
    !active && "hover:bg-aolda-tint",
    active && "bg-aolda-tint",
    "focus-visible:ring-2 focus-visible:ring-aolda-brand",
    className,
...
>(({ className, ...props }, ref) => (
  <hr
    ...
    className={cn("mx-2 min-h-px h-px border-0 bg-aolda-hairline", className)}
    {...props}
  />
));
...
const SidebarInput = forwardRef<HTMLButtonElement, SidebarInputProps>(
  (
    ...
    <button
      ...
      {...props}
    >
      <MagnifyingGlassIcon className="size-4 shrink-0 text-aolda-subtle" />
      <span className="flex-1 truncate text-left group-data-[state=collapsed]/sidebar:hidden">
        {children ?? placeholder}
      </span>
      {shortcut && (
        <kbd className="ml-auto font-sans text-xs text-aolda-subtle group-data-[state=collapsed]/sidebar:hidden">
          {shortcut}
        </kbd>
      )}
    </button>
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "text-aolda-subtle hover:text-aolda-strong hover:bg-aolda-overlay",
        "focus-visible:ring-2 focus-visible:ring-aolda-brand",
        "transition-colors duration-150",
        className,
      )}
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "hover:bg-aolda-brand/30 active:bg-aolda-brand/50",
        side === "left" && "right-0",
        side === "right" && "left-0",
        className,
      )}
...
function SidebarMenuChevron({ className }: { className?: string }) {
  return (
    <CaretRightIcon
      className={cn(
        "ml-auto size-4 shrink-0 text-aolda-subtle transition-transform duration-200",
