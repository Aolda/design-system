...
export const AOLDA_DROPDOWN_VARIANTS = {
  variant: {
    default: {
      classes: "",
    ...
    danger: {
      classes:
        "text-aolda-danger data-highlighted:bg-aolda-danger/5 data-highlighted:text-aolda-danger",
      description: "Destructive action item",
    },
  },
} as const;

export const AOLDA_DROPDOWN_DEFAULT_VARIANTS = {
  variant: "default",
} as const;

// Derived types from AOLDA_DROPDOWN_VARIANTS
export type AoldaDropdownVariant = keyof typeof AOLDA_DROPDOWN_VARIANTS.variant;

export interface AoldaDropdownVariantsProps {
  /**
   ...
   * @default "default"
   */
  variant?: AoldaDropdownVariant;
}

export function dropdownVariants({
  variant = AOLDA_DROPDOWN_DEFAULT_VARIANTS.variant,
}: AoldaDropdownVariantsProps = {}) {
  return cn(AOLDA_DROPDOWN_VARIANTS.variant[variant].classes);
}
...
>(({ className, inset, children, icon: IconComponent, ...props }, ref) => (
  <DropdownMenuPrimitive.SubmenuTrigger
    ...
    className={cn(
      ...
      "px-2 py-1.5", // spacing
      "focus:bg-aolda-tint focus:ring-aolda-focus/50 focus-visible:ring-2 focus-visible:ring-aolda-brand", // focus state
      "data-[state=open]:bg-aolda-tint", // open state
      ...
      <DropdownMenuPrimitive.Portal container={container}>
        ...
        >
          <DropdownMenuPrimitive.Popup
            className={cn(
              "overflow-hidden bg-aolda-control text-aolda-default", // background
              "rounded-lg shadow-lg ring ring-aolda-line", // border part
  ...
  (
    ...
    return (
      <DropdownMenuPrimitive.Item
        ref={ref}
        className={cn(
          "relative flex cursor-default items-center rounded-md px-2 py-1.5 text-base outline-hidden select-none focus:text-aolda-default focus:ring-aolda-focus/50 focus-visible:ring-2 focus-visible:ring-aolda-brand data-disabled:pointer-events-none data-disabled:opacity-50 data-highlighted:bg-aolda-overlay",
          inset && "pl-8",
    ...
    return (
      <DropdownMenuPrimitive.LinkItem
        ...
        className={cn(
          ...
          "focus:text-aolda-default focus:ring-aolda-focus/50 focus-visible:ring-2 focus-visible:ring-aolda-brand data-disabled:pointer-events-none data-disabled:opacity-50 data-highlighted:bg-aolda-overlay",
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn(
      "relative flex cursor-default items-center rounded-sm py-1.5 pr-2 pl-8 text-base outline-hidden transition-colors select-none focus:bg-aolda-tint focus:text-aolda-default focus:ring-aolda-focus/50 focus-visible:ring-2 focus-visible:ring-aolda-brand data-disabled:pointer-events-none data-disabled:opacity-50",
      className,
    )}
    checked={checked}
    {...props}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Separator
    ref={ref}
    className={cn("-mx-1 my-1 h-px bg-aolda-hairline", className)}
    {...props}
  />
));
...
>(({ className, children, inset, icon: IconComponent, ...props }, ref) => (
  <DropdownMenuPrimitive.RadioItem
    ...
    className={cn(
      "relative flex cursor-default items-center rounded-md px-2 py-1.5 text-base outline-hidden select-none",
      "data-disabled:pointer-events-none data-disabled:opacity-50 data-highlighted:bg-aolda-tint",
      inset && "pl-8",
      className,
    )}
    {...props}
