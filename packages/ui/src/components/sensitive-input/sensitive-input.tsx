...
import {
  ...
  type AoldaInputSize,
  type AoldaInputVariant,
} from "../input/input";
import { Field, type FieldErrorMatch } from "../field/field";

export const AOLDA_SENSITIVE_INPUT_VARIANTS = AOLDA_INPUT_VARIANTS;

export const AOLDA_SENSITIVE_INPUT_DEFAULT_VARIANTS = {
  size: "base",
  variant: "default",
} as const;
  ...
  (
    {
      ...
      onValueChange,
      onCopy,
      size = AOLDA_SENSITIVE_INPUT_DEFAULT_VARIANTS.size,
      variant = AOLDA_SENSITIVE_INPUT_DEFAULT_VARIANTS.variant,
      disabled = false,
      readOnly = false,
      id,
      autoComplete = "off",
    ...
    const containerClassName = cn(
      ...
      "focus-within:outline focus-within:outline-2 focus-within:outline-aolda-focus",
    ...
    const containerContent = (
      <>
        ...
        <BaseInput
          ...
          className={cn(
            "w-full border-0 bg-transparent p-0 text-aolda-default ring-0 outline-none aolda-input-placeholder disabled:cursor-not-allowed disabled:text-aolda-subtle",
            size === "xs" && "pr-5",
            size === "sm" && "pr-6",
            size === "base" && "pr-8",
            size === "lg" && "pr-10",
        ...
        <span
          className={cn(
            ...
            // Text color - use text-aolda-default to contrast with bg-aolda-control input background
            "text-aolda-default",
        ...
        >
          ...
          <span className="relative">
            ...
            {isMaskedWithValue && !disabled && (
              <span className="invisible absolute left-0 top-0 whitespace-nowrap text-aolda-subtle group-focus-within/container:visible group-hover/mask:visible">
                Click to reveal
              </span>
            )}
          </span>
        ...
        <button
          ...
          className={cn(
            "absolute top-1/2 right-0 -translate-y-1/2 cursor-pointer text-aolda-subtle hover:text-aolda-default focus:text-aolda-default focus:ring-aolda-focus/50 focus-visible:ring-2 focus-visible:ring-aolda-brand focus-visible:rounded-sm",
        ...
        {hasValue && !disabled && (
          <button
            ...
            className={cn(
              "absolute -top-px right-2 -translate-y-full cursor-pointer rounded-t-md bg-aolda-brand px-2 py-0.5 text-xs text-white opacity-0 transition-opacity group-focus-within/container:opacity-100 group-hover/container:opacity-100 hover:brightness-120 focus:outline-none focus:ring-aolda-focus/50 focus-visible:ring-2 focus-visible:ring-aolda-brand",
